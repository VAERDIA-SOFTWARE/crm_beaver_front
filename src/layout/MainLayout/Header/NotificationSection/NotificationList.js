...
import { useMarkNotificationAsRead } from 'services/users.service';
...
const NotificationList = ({ notificationsQueryData }) => {
  ...
  return (
    ...
    >
      {notificationsQueryData?.map((notification) => (
        <>
          <ListItemWrapper
            onClick={() => {
          ...
          >
            <ListItem alignItems="center">
              {false && (
                <ListItemAvatar>
                  <Avatar alt={notification?.titre} src={User1} />
                </ListItemAvatar>
              )}
              <ListItemText primary={notification?.titre} />
              {/* <ListItemSecondaryAction>
              ...
              <Grid item xs={12}>
                {false && (
                  <Grid container>
                    {notification?.vue != 0 ? (
                      <Grid item>
                        <Chip label="Vu" sx={chipSuccessSX} />
                      </Grid>
                    ) : null}
                  </Grid>
                )}
                {notification?.vue == 0 && (
                  ...
                  >
                    <Typography
                      ...
                      color="primary"
                      onClick={async () => {
                        await markNotificationAsReadMutation.mutateAsync({ id: notification?.id });
                      }}
                    >
                      Marquer comme lu
                    </Typography>
