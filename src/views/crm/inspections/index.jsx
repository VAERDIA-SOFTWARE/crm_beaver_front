...
const InspectionsList = ({ title, userId = '', overrideData, disableAdresse, disableEtat, disableAffectationDate }) => {
  ...
  return (
    <MainCard>
      <div style={{ display: overrideData ? 'none' : 'flex', alignContent: 'center', justifyContent: 'space-between' }}>
        <Tabs
          style={{ display: overrideData ? 'none' : 'flex' }}
          value={tabValue}
        ...
        >
          ...
          {/* <Tab to="#" label="Inspection à faire" />
          <Tab to="#" label="Inspection terminé" />
          <Tab to="#" label="Inspections validées" /> */}
