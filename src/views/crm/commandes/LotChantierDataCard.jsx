...
export default function LotChantierDataCard({ data, sx = {}, user }) {
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="h5">Taux d'échantillonnage</Typography>
        <Stack
          style={{
            marginTop: 0
          }}
      ...
      >
        <Typography variant="h5">Interventions restantes</Typography>
        <Stack
          style={{
            marginTop: 0
          }}
        >
          <Stack direction="row" spacing={1}>
            <Grid container spacing={2} alignItems="center" justifyContent="center">
              <Grid item xs>
                <BorderLinearProgress variant="determinate" color="primary" value={data?.inspections_progress} />
              </Grid>
              <Grid item>
      ...
      >
        <Typography variant="h5">Interventions terminées</Typography>
        <Stack
          style={{
            marginTop: 0
          }}
