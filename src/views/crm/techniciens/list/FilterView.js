...
import ColorsOptions from 'views/application/e-commerce/ColorOptions';
...
const ClientFilterView = ({ filter, filterIsEqual, handelFilter, initialState, open, handleCloseDialog }) => {
