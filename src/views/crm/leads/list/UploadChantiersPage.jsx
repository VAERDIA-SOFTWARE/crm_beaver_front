...
const UploadChantiersPage = () => {
  ...
  return (
    <MainCard title="Importer la liste des chantiers" backButton goBackLink="/clients/list">
      <div
        style={{
          maxWidth: 650,
          marginLeft: 'auto',
...
UploadChantiersPage.propTypes = {
  open: PropTypes.bool,
  handleCloseDialog: PropTypes.func
};

export default UploadChantiersPage;
