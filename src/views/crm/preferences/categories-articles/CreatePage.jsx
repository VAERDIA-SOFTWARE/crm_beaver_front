...
import { useCreateSettingsCategoryArticle } from 'services/settings.service';

const CategorieCreatePage = () => {
  const location = useLocation();
  const goBackLink = location.state?.goBackLink;
  const createCategorieMutation = useCreateSettingsCategoryArticle();
  ...
  return (
    <MainCard title="Ajouter Catégorie Article" backButton goBackLink={goBackLink}>
      <div
        style={{
          maxWidth: 2000,
          marginLeft: 'auto',
