...
import { useGetSettingsCategoryClientById } from 'services/settings.service';
...
const CategorieDetailsPage = () => {
  ...
  return (
    <MainCard
      title={`Catégorie Clients${categorieQueryData?.intitule ? '- ' + categorieQueryData?.intitule : ''}`}
      backButton
      goBackLink="/admin/categories-clients"
      secondary={
        <div
          style={{
            display: 'flex',
        ...
        >
          ...
          {user?.role.includes('admin') && (
            <IconButton
              ...
              size="large"
              onClick={(e) => {
                navigate(`/admin/categories-clients/${categorieId}/update`);
              }}
            >
