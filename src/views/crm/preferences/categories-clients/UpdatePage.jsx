...
import {
  useGetSettingsCategoryClientById,
  useUpdateSettingsCategoryClient,
  useDeleteSettingsCategoryClient
...
const CategorieUpdatePage = () => {
  ...
  const deleteCategorieMutation = useDeleteSettingsCategoryClient(categorieId);
  ...
  const getCategorieQuery = useGetSettingsCategoryClientById(categorieId);
  ...
  const updateCategorieMutation = useUpdateSettingsCategoryClient(categorieId);
  ...
  return (
    <MainCard
      title={`Modifier Catégorie Client ${categorieQueryData?.intitule ? '- ' + categorieQueryData?.intitule : ''}`}
      backButton
            ...
            <Grid item sx={{ display: 'flex', justifyContent: 'flex-end' }} xs={12}>
              <LoadingButton
                ...
                onClick={async () => {
                  ...
                  navigate(`/admin/categories-clients/${categorieId}/details`, {
                    replace: true
                  });
                }}
                variant="contained"
