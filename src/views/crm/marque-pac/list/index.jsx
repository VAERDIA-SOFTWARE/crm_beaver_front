...
import { useGetMarquePacs } from 'services/marque-pac.service';
const UsersList = () => {
  const [page, setPage] = React.useState(1);
  const [pageSize, setPageSize] = React.useState(10);
  const [searchFilter, setSearchFilter] = React.useState('');

  const getArticlesQuery = useGetMarquePacs({ page: page, searchFilter: searchFilter, paginated: true });
